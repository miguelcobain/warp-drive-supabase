...
- Made the `EmbedRef` returned by `embed()` directly configurable with selection, nested embeds,
  filtering, and child ordering, while retaining its related filter and parent-ordering use.
