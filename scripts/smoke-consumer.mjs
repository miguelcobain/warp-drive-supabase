...
writeFileSync(
  ...
  [
    ...
    "import type { Filter, OrderField, PageOptions, PostgrestCountMode } from 'warp-drive-supabase';",
    '',
    ...
    "const filter: Filter<Post> = { created_at: { gte: '2026-01-01' } };",
    "const page: PageOptions = { size: 20, count: 'exact' satisfies PostgrestCountMode };",
    "const queryRequest = query<Post>('post', { filter, order: [{ field: orderField, direction: 'desc' }], page });",
